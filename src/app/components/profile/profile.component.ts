...
import { PostService } from '../feed-page/post.service';
...
export class ProfileComponent implements OnInit {
  ...
  onSavePost() {
    ...
    if ( this.form.value.image != null){
        this.postsService.addPostProfile( 
  ...
  deletePostProfile(postId: string): void {
    this.isLoading = true;
    this.postsService.deletePostProfile(postId);
  }
